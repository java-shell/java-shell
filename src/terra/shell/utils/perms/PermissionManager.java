...
public class PermissionManager extends SecurityManager {
	...
	public void checkUserPermission(PermissionToken perm, User u, UserValidation validation)
	...
	public PermissionToken assignPermissionToken(User u, UserValidation validation, PermissionToken perm)
			throws InvalidUserException {
